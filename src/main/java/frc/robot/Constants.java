...
public class Constants // everything is fake
{
    ...
    public static final int LEFT_TRANSPORT_MOTOR_PORT = 5;
    public static final int RIGHT_TRANSPORT_MOTOR_PORT = 6;
    public static final int CENTRAL_TRANSPORT_SENSOR_PORT = 7;
    public static final int AMP_MODE_SENSOR_PORT = 8;
    public static final int TOP_INTAKE_MOTOR_PORT = 9;
    public static final int BOTTOM_INTAKE_MOTOR_PORT = 9;
